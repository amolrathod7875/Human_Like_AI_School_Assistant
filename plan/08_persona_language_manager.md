...
Implement role-specific AI persona configuration and language selection.
...
- should persist in conversation
- should have controlled fallback to English

## Acceptance Tests

- all roles map to expected personas
- all languages normalize correctly
- unsupported language falls back safely
- role cannot change persona permissions
