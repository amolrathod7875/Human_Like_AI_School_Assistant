...
# SECTION 18 — HUGGING FACE DEPLOYMENT
...
Deploy the integrated Python backend to Hugging Face Spaces.

## In Scope

- Dockerfile or supported deployment configuration
- startup command
- environment secrets
- health check
- CORS
...
Only include secrets actually required by final implementation.
